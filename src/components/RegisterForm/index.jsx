    ...
    <div className={cx("wrap")}>
      <form className={cx("form")} onSubmit={formik.handleSubmit}>
        <div className={cx("form-wrap")}>
          <div className="">
            <div className="d-md-flex w-100 gap-4">
            ...
            <div className="d-md-flex w-100 gap-4 align-items-center">
              <div className={cx("form-group")}>
        ...
        <div className={cx("btn-wrap", "gap-1 gap-sm-4 row")}>
          <button
            className={cx("btn-custom", "shadow-sm col-sm-2 col-12")}
            type="reset"
