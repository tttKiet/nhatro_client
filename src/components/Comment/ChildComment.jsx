        ...
        <div className={cx("content")}>
          <div className={cx("main")}>
            ...
            <p className={cx("description")}>
              Thay mặt nghành xin lỗi admin nha nhưng view sông dị mà 42tr/m2 đc
              hông admin Nhà Sài Gòn giá Bình Dương Sổ hồng nhận liền sau khi
              bàn giao
            </p>
          </div>
